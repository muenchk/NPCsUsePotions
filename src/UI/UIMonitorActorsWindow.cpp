...
namespace NPCsUsePotions
{
	namespace UserInterface
	{
		...
		void ActorMonitor::Draw()
		{
			...
			ImGui::SetNextWindowSize(ImVec2{ (float)RE::BSGraphics::Renderer::GetScreenSize().width * 0.5f, (float)RE::BSGraphics::Renderer::GetScreenSize().height * 0.25f }, ImGuiCond_Appearing);
			...
			if (ImGui::Begin("NUP Actor Monitor", nullptr, window_flags)) {
				...
				if (ImGui::BeginTable("itemtable", 10, flags, ImVec2(0.0f, 0.0f), 0.0f)) {  // ImGui::GetTextLineHeightWithSpacing() * rownum
					...
					ImGui::TableSetupColumn("Health", ImGuiTableColumnFlags_DefaultSort | ImGuiTableColumnFlags_WidthStretch, 50.f, UIColumns::ColumnID::ColDurHealth);
					ImGui::TableSetupColumn("Magicka", ImGuiTableColumnFlags_DefaultSort | ImGuiTableColumnFlags_WidthStretch, 50.f, UIColumns::ColumnID::ColDurMagicka);
					ImGui::TableSetupColumn("Stamina", ImGuiTableColumnFlags_DefaultSort | ImGuiTableColumnFlags_WidthStretch, 50.f, UIColumns::ColumnID::ColDurStamina);
		...
		std::shared_ptr<ActorMonitor> ActorMonitor::GetSingletonShared()
		{
			static std::shared_ptr<ActorMonitor> sharedwindow = std::shared_ptr<ActorMonitor>(GetSingleton());
			return sharedwindow;
		}
